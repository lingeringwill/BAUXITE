def bigMeatyClaws():
    ...
    text_label_name = tk.Label(app, text="Congrats! You found a ", font="Helvetica, 16")
    text_label_points = tk.Label(app, text="Congrats! Point Value: ", font="Helvetica, 16")
    ...
    def take_photo():
        ...
        additionalPoints += points_dict[labels_dict[idItem]]
    ...
    button1 = tk.Button(app, text="Return to Main Menu", command=quitApp)
    button1.pack()

    button2 = tk.Button(app, text="Take photo", command=take_photo)
    button2.pack()
